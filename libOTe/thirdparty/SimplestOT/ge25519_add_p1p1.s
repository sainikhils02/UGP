...
# qhasm: enter ge25519_add_p1p1
.text
.p2align 5
.globl _ge25519_add_p1p1
.globl ge25519_add_p1p1
_ge25519_add_p1p1:
ge25519_add_p1p1:
mov %rsp,%r11
and $31,%r11
...
# asm 1: add  CONST_2P1234,<a1=int64#5
# asm 2: add  CONST_2P1234,<a1=%r8
add  CONST_2P1234,%r8
...
# asm 1: add  CONST_2P1234,<a2=int64#6
# asm 2: add  CONST_2P1234,<a2=%r9
add  CONST_2P1234,%r9
...
# asm 1: add  CONST_2P1234,<a3=int64#7
# asm 2: add  CONST_2P1234,<a3=%rax
...
# asm 1: add  CONST_2P1234,<a4=int64#8
# asm 2: add  CONST_2P1234,<a4=%r10
...
# qhasm: t10 += *(uint64 *) &CONST_2P0
# asm 1: add  CONST_2P0,<t10=int64#3
# asm 2: add  CONST_2P0,<t10=%rdx
add  CONST_2P0,%rdx
...
# qhasm: t11 += *(uint64 *) &CONST_2P1234
# asm 1: add  CONST_2P1234,<t11=int64#5
# asm 2: add  CONST_2P1234,<t11=%r8
add  CONST_2P1234,%r8
...
# qhasm: t12 += *(uint64 *) &CONST_2P1234
# asm 1: add  CONST_2P1234,<t12=int64#6
# asm 2: add  CONST_2P1234,<t12=%r9
add  CONST_2P1234,%r9
...
# qhasm: t13 += *(uint64 *) &CONST_2P1234
# asm 1: add  CONST_2P1234,<t13=int64#7
# asm 2: add  CONST_2P1234,<t13=%rax
add  CONST_2P1234,%rax
...
# qhasm: t14 += *(uint64 *) &CONST_2P1234
# asm 1: add  CONST_2P1234,<t14=int64#8
# asm 2: add  CONST_2P1234,<t14=%r10
add  CONST_2P1234,%r10
...
# qhasm: rx0 += *(uint64 *)&CONST_2P0
# asm 1: add  CONST_2P0,<rx0=int64#5
# asm 2: add  CONST_2P0,<rx0=%r8
add  CONST_2P0,%r8

# qhasm: rx1 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rx1=int64#7
# asm 2: add  CONST_2P1234,<rx1=%rax
add  CONST_2P1234,%rax

# qhasm: rx2 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rx2=int64#8
# asm 2: add  CONST_2P1234,<rx2=%r10
add  CONST_2P1234,%r10

# qhasm: rx3 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rx3=int64#9
# asm 2: add  CONST_2P1234,<rx3=%r11
add  CONST_2P1234,%r11

# qhasm: rx4 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rx4=int64#10
# asm 2: add  CONST_2P1234,<rx4=%r12
...
# qhasm:   (uint128) mulrdx mulrax = mulrax * *(uint64 *)&CONST_EC2D2
mulq  CONST_EC2D2
...
# qhasm:   (uint128) mulrdx mulrax = mulrax * *(uint64 *)&CONST_EC2D1
mulq  CONST_EC2D1
...
# qhasm:   (uint128) mulrdx mulrax = mulrax * *(uint64 *)&CONST_EC2D0
mulq  CONST_EC2D0
...
# qhasm:   (uint128) mulrdx mulrax = mulrax * *(uint64 *)&CONST_EC2D3
mulq  CONST_EC2D3
...
# qhasm:   (uint128) mulrdx mulrax = mulrax * *(uint64 *)&CONST_EC2D4
mulq  CONST_EC2D4
...
# qhasm: rt0 += *(uint64 *)&CONST_2P0
# asm 1: add  CONST_2P0,<rt0=int64#5
# asm 2: add  CONST_2P0,<rt0=%r8
add  CONST_2P0,%r8

# qhasm: rt1 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rt1=int64#4
# asm 2: add  CONST_2P1234,<rt1=%rcx
add  CONST_2P1234,%rcx

# qhasm: rt2 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rt2=int64#6
# asm 2: add  CONST_2P1234,<rt2=%r9
add  CONST_2P1234,%r9

# qhasm: rt3 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rt3=int64#7
# asm 2: add  CONST_2P1234,<rt3=%rax
add  CONST_2P1234,%rax

# qhasm: rt4 += *(uint64 *)&CONST_2P1234
# asm 1: add  CONST_2P1234,<rt4=int64#8
# asm 2: add  CONST_2P1234,<rt4=%r10
add  CONST_2P1234,%r10
